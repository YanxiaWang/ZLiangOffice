...
#define NOTIFICATION_ORDERCANCEL @"orderCancel"  // 取消订单
#define NOTIFICATION_CURRENTSTAR @"currentStar"  // 当前星级
#define NOTIFICATION_RECEIVEORDER  @"receiveOrder" // 接单
...
// 弱引用
#define UBWeakSelf(type)  __weak typeof(type) weak##type = type;
// 强引用
#define UBStrongSelf(type)  __strong typeof(type) type = weak##type;
//快速枚举
